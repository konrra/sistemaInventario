...
<div class="panel panel-default">
	  ...
	  <div class="form-group">
	    <label  class="col-lg-2 control-label">N&uacute;mero tel&eacute;fono celular</label>
	    <div class="col-xs-3">
	      <input type="text" class="form-control" name="num_tel_cel" value="${cliente.num_tel_cel }"  placeholder="61234567" >
	    </div>
	  </div>
	   <div class="form-group">
	    <label  class="col-lg-2 control-label">N&uacute;mero tel&eacute;fono fijo</label>
	    <div class="col-xs-3">
