...
<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/saveAusenciaMed">
</br>
<div class="form-group">
    <div class="col-xs-3">
      <input  type="hidden" value="M" class="form-control" name="tipo_ausencia"   placeholder="Nombre" >
    </div>
  </div>
