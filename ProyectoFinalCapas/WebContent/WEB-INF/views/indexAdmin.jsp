  ...
  <div class="panel-heading">
   	...
   	<nav class="navbar navbar-dark bg-dark">
		  ...
		  <div class="collapse navbar-collapse" id="navbarText">
		    <ul class="navbar-nav mr-auto">
		      <li class="nav-item active">
		        <a class="nav-link"  href="${pageContext.request.contextPath}/listadoCliente">Clientes <span class="sr-only">(current)</span></a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="${pageContext.request.contextPath}/listadoProducto">Productos</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="${pageContext.request.contextPath}/listadoCategoria">Categoria Producto</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="${pageContext.request.contextPath}/listadoLugar" >Origen/Destino</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link" href="#">Registrar Salidas</a>
		      </li>
