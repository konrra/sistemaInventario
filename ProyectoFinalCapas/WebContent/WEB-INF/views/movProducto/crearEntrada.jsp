...
<div class="card">
 ...
 <div class="form-row">
  <div style="width: 50%; float: left;" >
	...
	<input type="hidden" class="col-sm-8 col-form-control" name="id_producto" value="${idProducto}" >
    <input type="text" class="col-sm-8 col-form-control" value="${nombreProducto}" >
    	</c:if>
    	  <c:if test="${idProducto == null }">
    		<input type="text" class="col-sm-8 col-form-control"  value = "valor defecto">
    	</c:if>
    	<button type="button" style="float: right;" class="col-sm-3 btn-info btn-sm" onclick="location.href='${pageContext.request.contextPath}/listadoMovProducto'" > Listado Producto </button>
	 </div>
	</div>
		    ...
		    <div class="col-sm-7">
		      <input type="text" class="form-control" name="cantidad" value="${movproducto.cantidad }" >
		    </div>
	    </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-7 ">
	      <input type="text" class="form-control" name="comentario" value="${movproducto.comentario }"  placeholder="Agregue comentario si es requerido" >
	    </div>
	  </div>
